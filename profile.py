...
node_webserver.addService(pg.Execute(shell="sh", command="cd ~"))
node_webserver.addService(pg.Execute(shell="sh", command="sudo git clone https://github.com/js637496/assignment2public.git"))
node_webserver.addService(pg.Execute(shell="sh", command="sleep 30s"))
...
node_observer.addService(pg.Execute(shell="sh", command="cd ~"))
